...
h1("Shared Tweets: An Analysis of Global Twitter Data"),
  ...
  p("The domain that we are focusing on is", strong("Twitter data"), "as it is a
  highly popular social media platform that gives us an insight to individuals
  ...
  "as well as", strong("any person"), "that chooses to use the platform. This
  ...
  strong("1. What is the most popular weekday to post to Twitter based on the
         users’ region?"),
  p("Sources that contain this information are the Senators data since they are
    all from the United States, as well as, the Russian Troll data as it
    includes region as well as the text of a given tweet."),
  strong("2. How does the number of hashtags in a tweet relate to the number of
         retweets it receives?"),
  p("Sources that contain this information are the Senators data as it includes
  ...
  p("The source that contains this information is the Sentiment 140 which allows
    us to look at the polarity of a tweet and compare it to its time
    of publish."),
img("", src = "https://media.sproutsocial.com/uploads/2019/08/twitter-stats.svg"
      , align = "center"),
  h2("Datasets Info"),
  strong("1. Russian Troll Tweets:"), a("link", href =
...
IRAhandle_tweets_1.csv"),
  p("This dataset was collected by researchers Oliver Roeder, Dhrumil Mehta,
   ...
   strong("2. Senators' Tweets:"), a("link", href =
"https://github.com/fivethirtyeight/data/blob/master/twitter-ratio/senators.csv"
  ...
  strong("3. 1.6 Million Tweets:"), a("link", href =
"https://www.kaggle.com/kazanova/sentiment140/data#"),
  p("A machine learning approach for automatically classifying the sentiment of
