    ...
    sidebarLayout(
      sidebarPanel(
        checkboxGroupInput("day_of_week",
          label = h3("Select day to remove"),
          choices = list(
            Friday = "Friday", Monday = "Monday", Saturday = "Saturday",
            Sunday = "Sunday", Thursday = "Thursday", Tuesday = "Tuesday",
            Wednesday = "Wednesday"
          ),
          selected = c(
        ...
        sliderInput("donut_size",
          label = h3("Size Donut"), min = 0,
          max = 0.6, value = 0
        )
      ),
      mainPanel(
